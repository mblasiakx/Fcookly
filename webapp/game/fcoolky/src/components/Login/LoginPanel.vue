...
<div class="wrapper">
  <div class="rec-prism" :class="{animate: animatePanel, animate2: animatePanel2,
  animate3: animatePanel3,animate4: animatePanel4, animate5: animatePanel5}">
...
<ul class="nav">
  <li @click="showLogin">Sign up</li>
  <li @click="showSignup">Sign in</li>
  <li @click="showForgotPassword">Forgot password</li>
  <li @click="showContact">Contact with us</li>
  <li @click="showSubscribe">Subscribe us</li>
</ul>
...
export default{
  ...
  return{
    ...
    showLogin() {
     ...
     this.animatePanel2=false
     this.animatePanel3=false
     this.animatePanel4=false
      this.animatePanel5=false
    },
    
    showSignup() {
     
    this.animatePanel=false
    this.animatePanel2=true
    this.animatePanel3=false
     this.animatePanel4=false
      this.animatePanel5=false
    },
